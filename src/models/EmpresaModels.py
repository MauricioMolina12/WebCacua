...
class Empresa(db.Model):
    ...
    def __init__(self, id_Empresa, Nombre_Empresa, Nic_Empresa, Correo_Empresa, Fecha_Inicio, Fecha_Final, Modulo, Status):
...
class UsersSchema(ma.Schema):
    class Meta:
        fields = ('id_Empresa', 'Nombre_Empresa', 'Nic_Empresa', 'Correo_Empresa', 'Fecha_Inicio', 'Fecha_Final', 'Modulo', 'Status')
