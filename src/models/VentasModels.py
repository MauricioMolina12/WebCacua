...
class Ventas(db.Model):
    ...
    id_UsuarioVendedor = db.Column(db.Integer, db.ForeignKey('Tb_Tb_Usuarios.id_Usuario'), nullable=False)
    id_UsuarioCliente = db.Column(db.Integer, db.ForeignKey('Tb_Tb_Usuarios.id_Usuario'), nullable=False)
